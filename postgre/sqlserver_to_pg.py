...
# postgres user password from environment variables
...
# ETL Pipeline: extract data from sql server
def extract():
    try:
        connection_string = (
            f'DRIVER={driver};'
        ...
        query = """ select  t.name as table_name
            from sys.tables t where t.name in ('DimProduct','DimProductSubcategory','DimProductSubcategory',
        ...
        for id in src_tables:
            ...
            load(df, table_name)  # load function call
